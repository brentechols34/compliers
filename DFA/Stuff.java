...
public class Stuff {
	...
	private static String plus = "a:(+)b b<<:()b"; //+
	private static String equality = "a:(<>)b,(=)c b<<:(=)c c<<:()"; //=<, <, >=, >, =
	...
	public static void main(String[] args) throws FileNotFoundException {
		String[] stuff = new String[] {integer,fixed,fp,identifier, unclosedComment, comment, stringLiteral,plus,equality};
		String[] names = new String[] {"integer","fixed","fp","identifier", "unclosedComment", "comment", "stringLiteral", "plus", "equality"};
